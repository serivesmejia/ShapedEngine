...
interface ShapedShapeBuilder {
    ...
    fun triangle(triangle: Triangle2, color: Color4 = defColor)

    fun texturedTriangle(triangle: Triangle2, texture: ShapedTexture, color: Color4 = defColor)
    ...
    fun circle(rect: Rectangle2, color4: Color4 = defColor)
